...
public class ClienteController implements Serializable {
    ...
    public String create() {
        try {
            ...
            recreateModel();
            FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("CLIENTE", current);
            return "/paginas/credito/Create.xhtml";
        } catch (Exception e) {
    ...
    public void buscarXdni() {
        try {
            ...
            current = ejbFacade.buscarPorDni(current.getDni());
            if (current != null) {
                creditos = current.getCreditoList();
                logged = true;
