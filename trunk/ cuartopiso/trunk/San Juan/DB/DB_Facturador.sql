...
INSERT INTO `articulos` (`id`, `sec`, `art`, `descripcion`, `precio`, `stock`) VALUES
(1, 1, 1234, 'Alfajores Jorgito x 10 unidades', 2.35, 23),
(2, 1, 3221, 'Alfajor Milka', 2.5, 100),
(3, 2, 5993, 'Chicles Beldent', 1.25, 49),
(4, 2, 3211, 'Topline x 7', 0.55, 122),
(5, 3, 9442, 'Coca Cola x 1.25 L', 5.75, 59),
(6, 3, 4563, 'Pepsi 750cm3', 3.9, 93),
(7, 3, 2311, 'Paso de los Toros 2Lts', 6.25, 110),
(8, 4, 21, '3D x 500gm', 6.15, 65),
(9, 4, 2315, 'Galletas Surtidas', 5.2, 45),
(10, 5, 8392, 'Pañuelos Descatables', 4.25, 54),
(11, 5, 4221, 'Prime Clasicos', 8.45, 76);
...
CREATE TABLE IF NOT EXISTS `empresas` (
  `id` int(2) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(50) CHARACTER SET utf8 COLLATE utf8mb4_spanish_ci NOT NULL,
